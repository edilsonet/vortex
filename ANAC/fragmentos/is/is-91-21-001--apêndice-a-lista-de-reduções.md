...
norma: "is-91-21-001"
fragmento: "is-91-21-001--apêndice-a-lista-de-reduções"
...
 30/10/2014                                                                                       IS nº 91.21-001
   ...
   Uso de PEDs        FDC        BDC         Emissores não intencionais             Emissores intencionais
                                          ...
                                          voo menos críticas, acima de         Proibidos em todas as fases de
Restrição padrão    NÍVEL 1    NÍVEL 1
                                          10.000 pés AGL e com a               voo. (B4.5.3.1)
                                          aeronave estacionada. (B4.4.2.1)
                                          Permitidos em praticamente todas
Expansão FDC por                          as fases de voo, porém com
                                                                               Proibidos em todas as fases de
análise, sem        NÍVEL 2    NÍVEL 1    limitações conforme mitigações e
                                                                               voo. (B4.5.3.1)
expansão BDC                              limitações operacionais definidas.
                                          (B4.4.2.2)
                                          Permitidos em praticamente todas
Expansão FDC por
                                          as fases de voo, porém com           Permitidos no taxi in, após livrar
análise e BDC por
                    NÍVEL 2     NÍVEL 2   limitações conforme mitigações e     a pista em uso, até o portão de
HIRF + Avaliação
                                          limitações operacionais definidas.   desembarque. (B4.5.3.2)
adicional.
                                          (B4.4.2.2)
                                          Permitidos em praticamente todas
...
análise e BDC por   NÍVEL 2     NÍVEL 3   limitações conforme mitigações e
                                                                               da demonstração de imunidade a
testes                                    limitações operacionais definidas.
                                                                               BDC. (B4.5.3.3)
                                          (B4.4.2.2)
                                          Podem ser permitidos até em
Expansão FDC por
                                          todas as fases de voo, conforme      Proibidos em todas as fases de
testes, sem         NÍVEL 3    NÍVEL 1
                                          escopo da demonstração de            voo. (B4.5.3.1)
expansão BDC
                                          imunidade a FDC. (B4.4.2.3)

Expansão FDC por                          Podem ser permitidos até em
                                                                               Permitidos no taxi in, após livrar
testes e BDC por                          todas as fases de voo, conforme
                    NÍVEL 3     NÍVEL 2                                        a pista em uso, até o portão de
HIRF + Avaliação                          escopo da demonstração de
                                                                               desembarque. (B4.5.3.2)
adicional                                 imunidade a FDC. (B4.4.2.3)

                                          Podem ser permitidos até em          Pode ser permitidos até em todas
Expansão FDC e                            todas as fases de voo, conforme      as fases de voo, conforme escopo
                    NÍVEL 3     NÍVEL 3
BDC por testes                            escopo da demonstração de            da demonstração de imunidade a
                                          imunidade a FDC. (B4.4.2.3)          BDC. (B4.5.3.3)
...
B7.2.         É aceitável a emissão de revisões temporárias, alertas ou qualquer outro método de
 ...
 1    deve incluir orientação para as situações nas quais os PED podem ser utilizados e      Completa
 ...
 2    fato de que o anúncio antes da partida é especialmente importante para a operação      Completa
      segura e para minimizar distrações causadas por PEDs durante os anúncios de
      segurança.
      O operador atualizou as suas listas de verificação de procedimentos e comunicação
 3    como apropriado, em consonância com as alterações implementadas para o uso             Completa
      expandido de PEDs.
 ...
 4    durante um acidente e evacuação de emergência.                                         Completa
...
 30/10/2014                                                                                          IS nº 91.21-001
 ...
 6                                                                                       Completa
   ...
   em Serviço” do operador, conforme IS no 00-001 da ANAC e/ou preenchimento e
...
B8.2.         É aceitável, provisoriamente, o fornecimento de orientações escritas ou orais, ou outro
 ...
 1      Orientação da tripulação para assegurar que problemas com a aeronave sejam reportados,        Completa
 ...
 2      passageiros. Veja o Apêndice C para informações adicionais.                                   Completa
 ...
 3      Descrição dos métodos de comunicação utilizados para informar os passageiros sobre as         Completa
        novas políticas.
        TRATAMENTO DO PASSAGEIRO
 4      Explicação de como os passageiros serão informados sobre quando é permitida a utilização      Completa
 ...
 5      usando seus PEDs de uma forma incômoda ou insegura (utilização dos autofalantes do PED
                                                                                                      Completa
 ...
 6      confirmada (veja acima), fogo ou fumaça causada pelo PED ou sua bateria e outros
                                                                                                      Completa
        cenários.
